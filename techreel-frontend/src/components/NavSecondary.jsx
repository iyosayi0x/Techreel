...
const NavSecondary=()=>{
    ...
    return (
        <section className='secondaryNav'>
            ...
            <div className='secondarylayout_header'>
                <Link to='/'><img src={Logo_blue} alt='techrel logo' /></Link>
            ...
            <nav className={navClass}>
                ...
                <ul className='nav_primary'>
                    ...
                    <NewsLetter list_class='nav_btn_secondary'/>
                    <div className='icon_wrapper' onClick={()=>setShowSearch(true)}>
                        <SearchIcon/>
                    </div>
                </ul>
